...
export class Stage {
  ...
  draw() {
    this.c.drawImage(
      ...
      0,
      this.dimensions.y * this.proportions,
      this.dimensions.y
    );
  }
}
...
export class Sprite {
  ...
  draw() {
    ...
    this.c.drawImage(
      ...
      0,
      this.image.width / this.frames.max - 0.5,
      this.image.height,
      this.position.x,
      this.position.y,
      (this.image.width * this.scaleDown) / this.frames.max,
      this.image.height * this.scaleDown
    );
    ...
    if (
      this.interval % 100 === 0 ||
      this.interval % (Math.floor(Math.random() * 100) === 0)
    ) {
...
export class Event {
  ...
  draw() {
    ...
    this.c.fillRect(
      this.position.x - this.width / 2 + 16 * 2,
      this.position.y - this.height / 2 + 16 * 2,
      this.width,
      this.height
    ); */
